...
function Register() {
    return (<>
    <h1 className='font-bold text-[40px]'>Bài 4 </h1>
  ...
  <input className="border-2 border-zinc-600 rounded-[5px] w-[25pc] h-[40px]" type="email" placeholder="Enter your email"/>
  <br /> <br />
  <label htmlFor="password">Your Password</label> <br />
  <input className="border-2 border-zinc-600 rounded-[5px] w-[25pc] h-[40px]" type="password" placeholder="Enter your password"/>
  <br /> <br />
  <label htmlFor="password">Confirm Password</label> <br />
  <input className="border-2 border-zinc-600 rounded-[5px] w-[25pc] h-[40px]" type="password" placeholder="Confirm your password"/>
  <br /> <br />
