...
function Register() {
    ...
    return (<div className="border-solid border-2 border-gray-700 w-[850px] flex gap-[20px] mt-[20px] rounded font-mono ml-[100px]">
      <div>
      ...
      <div>
        ...
        <input className="border-2 border-zinc-600 rounded-[5px] w-[25pc] h-[40px]" type="email" placeholder="Enter your email" value={email}/>{" "}
        <br /> <br />
        <label htmlFor="password">Password</label> <br />
        <input className="border-2 border-zinc-600 rounded-[5px] w-[25pc] h-[40px]" type="password" placeholder="Enter your password" value={password}/>{" "}
        <br /> <br />
