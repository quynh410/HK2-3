...
function Admin() {
    const [isDashboardOpen, setIsDashboardOpen] = (0, react_1.useState)(false);
      ...
      <header className="bg-gray-800 text-white py-4 px-6 flex justify-between items-center">
        ...
        <div className="flex items-center bg-gray-600 w-[120px] h-[40px] rounded-[20px] gap-[20px] ">
          <div className="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center ml-[10px]">
            <img src="https://cdn.thuvienphapluat.vn/phap-luat/2022/TTNHAN/0707/chup-anh.png" alt="" className="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center"/>
          </div>
          <span>Admin</span>
        </div>
      </header>
        ...
        <div className="bg-gray-800 h-screen flex">
          <div className="bg-gray-800 text-white w-64 py-6 px-4">
            <div className="bg-gray-300 h-[50px] rounded-[10px]">
              <a href="#" className="text-xl font-bold mb-8 flex items-center leading-10 gap-[10px]">
                <i className="fa-solid fa-plus ml-[10px]"></i> New Item
              </a>
            </div>
            <nav className="space-y-4">
              <a href="#" className="hover:bg-gray-700 rounded py-2 px-4 flex" onClick={toggleDashboardMenu}>
              ...
              {isDashboardOpen && (<div className="ml-6 space-y-2">
                  <a href="#" className="hover:bg-gray-700 rounded py-2 px-4 block">
                    Commarce
                  </a>
                  <a href="#" className="hover:bg-gray-700 rounded py-2 px-4 block">
                    Analytics
          ...
          <div className="flex-1 bg-gray-100 ">
            <div className="p-4 flex justify-between items-center bg-white pl-8">
              ...
              <div className="relative">
                <input type="text" className="px-4 py-2 rounded bg-gray-800 text-white border border-gray-700" placeholder="Search content..."/>
            ...
            <div className="flex justify-center space-x-2">
              <a href="#" className="px-3 py-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-100">
                <i className="fas fa-chevron-left"></i>
              </a>
              <a href="#" className="px-3 py-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-100">
                1
              </a>
              <a href="#" className="px-3 py-2 rounded-md bg-blue-500 text-white">
                2
              </a>
              <a href="#" className="px-3 py-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-100">
                3
